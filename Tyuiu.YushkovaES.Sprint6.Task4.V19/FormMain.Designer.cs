namespace Tyuiu.YushkovaES.Sprint6.Task4.V19
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelStatus_SIS = new Label();
            SuspendLayout();
            // 
            // labelTitle_SIS
            // 
            labelTitle_SIS.AutoSize = true;
            labelTitle_SIS.Font = new Font("Microsoft Sans Serif", 10F, FontStyle.Bold);
            labelTitle_SIS.Location = new Point(27, 31);
            labelTitle_SIS.Margin = new Padding(4, 0, 4, 0);
            labelTitle_SIS.Name = "labelTitle_SIS";
            labelTitle_SIS.Size = new Size(353, 20);
            labelTitle_SIS.TabIndex = 0;
            labelTitle_SIS.Text = "Табулирование и сохранение в файл";
            // 
            // labelStart_SIS
            // 
            ...
            // textBoxResult_SIS
            // 
            textBoxResult_SIS.Location = new Point(27, 200);
            ...
            // labelStatus_SIS
            // 
            labelStatus_SIS.AutoSize = true;
            labelStatus_SIS.Location = new Point(27, 492);
            labelStatus_SIS.Margin = new Padding(4, 0, 4, 0);
            labelStatus_SIS.Name = "labelStatus_SIS";
            labelStatus_SIS.Size = new Size(0, 20);
            labelStatus_SIS.TabIndex = 8;
            // 
            // FormMain
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(493, 538);
            Controls.Add(labelStatus_SIS);
            ...
            Text = "Спринт 6. Таск 4. Вариант 19";
        ...
        private System.Windows.Forms.Label labelStatus_SIS;
    }
}
